...
export async function POST(
  ...
  try {
    ...
    const res = await proxyFetch(
      request,
      `${API}/works/${encodeURIComponent(workId)}/sources/${encodeURIComponent(sourceId)}/branches/${encodeURIComponent(branchName)}/comments/${encodeURIComponent(commentId)}/flag`,
      {
        method: "POST",
        headers: {
