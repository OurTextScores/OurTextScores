...
export async function POST(
  ...
  try {
    ...
    const res = await fetch(
      `${API}/works/${encodeURIComponent(workId)}/sources/${encodeURIComponent(sourceId)}/revisions/${encodeURIComponent(revisionId)}/comments/${encodeURIComponent(commentId)}/flag`,
      {
        method: "POST",
        headers: {
